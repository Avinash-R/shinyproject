...
The Overall Rating and its six dependent features (complaints, privileges, learning, raises, critical, advance) are recorded in this data. 
...
## About the Shiny App
The user inputs the value for the feature : Handling of employee compliants. 

The input is recorded to predict the overall rating using a simple linear regression model fit. 
